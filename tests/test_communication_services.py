...
async def test_email_service():
    ...
    if not email_service.is_configured():
        ...
        print(f"   AZURE_COMMUNICATION_EMAIL_CONNECTION_STRING: {'✅' if os.getenv('AZURE_COMMUNICATION_EMAIL_CONNECTION_STRING') else '❌'}")
        print(f"   AZURE_EMAIL_SENDER_ADDRESS: {'✅' if os.getenv('AZURE_EMAIL_SENDER_ADDRESS') else '❌'}")
        return False
...
async def test_sms_service():
    ...
    if not sms_service.is_configured():
        ...
        print("   Missing environment variables:")
        print(f"   AZURE_COMMUNICATION_SMS_CONNECTION_STRING: {'✅' if os.getenv('AZURE_COMMUNICATION_SMS_CONNECTION_STRING') else '❌'}")
        print(f"   AZURE_SMS_FROM_PHONE_NUMBER: {'✅' if os.getenv('AZURE_SMS_FROM_PHONE_NUMBER') else '❌'}")
        return False
