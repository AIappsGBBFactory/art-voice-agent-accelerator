...
Usage:
    from apps.rtagent.backend.voice.speech_cascade.tts import TTSPlayback
...
if TYPE_CHECKING:
    from apps.rtagent.backend.src.orchestration.session_agents import get_session_agent
...
class TTSPlayback:
    ...
    def get_agent_voice(self) -> tuple[str, Optional[str], Optional[str]]:
        """
        ...
        *,
        ...
        async with self._tts_lock:
            ...
            try:
                ...
                # Stream to browser
                return await self._stream_to_browser(
                    pcm_bytes, on_first_audio, run_id
                )
        ...
        *,
        ...
        async with self._tts_lock:
            ...
            try:
                ...
                # Stream to ACS
                return await self._stream_to_acs(
                    pcm_bytes, blocking, on_first_audio, run_id
                )
