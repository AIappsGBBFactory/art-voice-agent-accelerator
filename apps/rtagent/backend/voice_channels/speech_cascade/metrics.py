...
_stt_recognition_histogram: Optional[Histogram] = None
_turn_processing_histogram: Optional[Histogram] = None
_barge_in_histogram: Optional[Histogram] = None
_turn_counter: Optional[Counter] = None
_barge_in_counter: Optional[Counter] = None
...
def record_stt_recognition(
    ...
    *,
    ...
    logger.debug(
        "📊 STT recognition metric: %.2fms | session=%s",
...
def record_turn_processing(
    ...
    *,
    ...
    logger.debug(
        ...
        latency_ms, session_id, has_tool_calls
    )
