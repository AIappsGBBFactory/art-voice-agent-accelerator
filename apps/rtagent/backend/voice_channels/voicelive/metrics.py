...
_llm_ttft_histogram: Optional[Histogram] = None
_tts_ttfb_histogram: Optional[Histogram] = None
_stt_latency_histogram: Optional[Histogram] = None
_turn_duration_histogram: Optional[Histogram] = None
_turn_counter: Optional[Counter] = None
...
def record_llm_ttft(
    ...
    *,
    ...
    logger.info(
        ...
        ttft_ms, session_id, turn_number, agent_name or "unknown"
    )
...
def record_tts_ttfb(
    ...
    *,
    ...
    logger.info(
        ...
        ttfb_ms, session_id, turn_number, reference, agent_name or "unknown"
    )
...
def record_stt_latency(
    ...
    *,
    ...
    logger.info(
        ...
        latency_ms, session_id, turn_number
    )
...
def record_turn_complete(
    ...
    *,
    ...
    _turn_duration_histogram.record(duration_ms, attributes={
        **base_attributes,
