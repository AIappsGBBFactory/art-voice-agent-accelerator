...
Usage:
    from apps.rtagent.backend.voice_channels.orchestrators.config_resolver import (
...
if TYPE_CHECKING:
    ...
    from apps.rtagent.agents.scenarios.loader import ScenarioConfig
...
def _load_base_agents() -> Dict[str, Any]:
    ...
    try:
        from apps.rtagent.agents.loader import discover_agents
...
def _build_base_handoff_map(agents: Dict[str, Any]) -> Dict[str, str]:
    ...
    try:
        from apps.rtagent.agents.loader import build_handoff_map
...
def _load_scenario(scenario_name: str) -> Optional["ScenarioConfig"]:
    ...
    try:
        from apps.rtagent.agents.scenarios import load_scenario
...
def _get_scenario_agents(scenario_name: str) -> Dict[str, Any]:
    ...
    try:
        from apps.rtagent.agents.scenarios import get_scenario_agents
