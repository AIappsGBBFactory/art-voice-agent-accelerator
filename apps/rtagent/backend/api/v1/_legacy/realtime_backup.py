...
# Import audio constants from media_handler for consistency
from ..handlers.media_handler import (
    pcm16le_rms as _pcm16le_rms,
    VOICE_LIVE_SPEECH_RMS_THRESHOLD as _VOICE_LIVE_SPEECH_RMS_THRESHOLD,
    VOICE_LIVE_SILENCE_GAP_SECONDS as _VOICE_LIVE_SILENCE_GAP_SECONDS,
    VOICE_LIVE_PCM_SAMPLE_RATE as _VOICE_LIVE_PCM_SAMPLE_RATE,
)
