...
from apps.rtagent.backend.src.agents.vlagent.tool_store.banking_email_templates import BankingEmailTemplates
...
async def send_card_agreement(args: SendCardAgreementArgs) -> Dict[str, Any]:
    ...
    try:
        ...
        # Get card details from product catalog
        # TODO: Query from Cosmos DB or use get_card_details tool
        card_details_map = {
            "travel-rewards-001": {
                "card_name": "Travel Rewards Credit Card",
                "annual_fee": 0,
                "regular_apr": "19.24% - 29.24% variable APR",
                "intro_apr": "0% APR for 12 months on purchases",
                ...
                "highlights": [
                    ...
                    "No fees at 40,000+ Bank of America ATMs"
                ]
            },
            "premium-rewards-001": {
                "card_name": "Premium Rewards Credit Card",
                "annual_fee": 95,
                "regular_apr": "19.24% - 29.24% variable APR",
                "intro_apr": "0% APR for 15 months on purchases and balance transfers",
            ...
            "cash-rewards-002": {
                "card_name": "Customized Cash Rewards Credit Card",
                "annual_fee": 0,
                "regular_apr": "19.24% - 29.24% variable APR",
                "intro_apr": "0% APR for 15 months on purchases and balance transfers",
                "rewards_rate": "3% cash back on choice category, 2% at grocery stores, 1% on everything else",
            ...
            "unlimited-cash-003": {
                "card_name": "Unlimited Cash Rewards Credit Card",
                "annual_fee": 0,
                "regular_apr": "19.24% - 29.24% variable APR",
                "intro_apr": "0% APR for 18 months on purchases and balance transfers",
        ...
        card_data = card_details_map.get(card_product_id, {
...
async def finalize_card_application(args: FinalizeCardApplicationArgs) -> Dict[str, Any]:
    ...
    try:
        ...
        # Map product IDs to card names
        card_name_map = {
            "travel-rewards-001": "Travel Rewards Credit Card",
            "premium-rewards-001": "Premium Rewards Credit Card",
            "cash-rewards-002": "Customized Cash Rewards Credit Card",
            "unlimited-cash-003": "Unlimited Cash Rewards Credit Card"
        }
        card_name = card_name_map.get(card_product_id, args.get("card_name", "Credit Card"))
        
        # Determine credit limit based on customer profile
        ...
        # Calculate credit limit based on profile
        if income_band == "high":
            credit_limit = 15000
        ...
        card_details = {
            ...
            "physical_card_delivery": "3-5 business days",
