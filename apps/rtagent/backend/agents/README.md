...
mkdir -p apps/rtagent/backend/agents/my_new_agent
```
...
```python
import pytest
from apps.rtagent.backend.agents.tools import initialize_tools, execute_tool
...
from apps.rtagent.backend.agents.tools import initialize_tools, list_tools
initialize_tools()
print(list_tools())  # Should include your tool

# Check for import errors
from apps.rtagent.backend.agents.tools import banking  # Should not error
```
