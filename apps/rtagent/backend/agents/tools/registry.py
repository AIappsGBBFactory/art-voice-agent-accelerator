...
Usage:
    from apps.rtagent.backend.agents.tools.registry import (
        register_tool,
        get_tools_for_agent,
        execute_tool,
        initialize_tools,
...
def initialize_tools() -> int:
    ...
    from apps.rtagent.backend.agents.tools import handoffs
    from apps.rtagent.backend.agents.tools import auth
    from apps.rtagent.backend.agents.tools import banking
    from apps.rtagent.backend.agents.tools import fraud
    from apps.rtagent.backend.agents.tools import escalation
    from apps.rtagent.backend.agents.tools import investment
    from apps.rtagent.backend.agents.tools import compliance
    from apps.rtagent.backend.agents.tools import voicemail
    from apps.rtagent.backend.agents.tools import call_transfer
    from apps.rtagent.backend.agents.tools import transfer_agency
    from apps.rtagent.backend.agents.tools import knowledge_base
    from apps.rtagent.backend.agents.tools import personalized_greeting
    from apps.rtagent.backend.agents.tools import customer_intelligence
