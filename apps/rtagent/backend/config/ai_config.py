...
AGENT_AUTH_CONFIG = os.getenv(
    "AGENT_AUTH_CONFIG", "apps/rtagent/backend/src/agents/artagent/insuranceagents/agent_store/auth_agent.yaml"
)

AGENT_CLAIM_INTAKE_CONFIG = os.getenv(
    "AGENT_CLAIM_INTAKE_CONFIG",
    "apps/rtagent/backend/src/agents/artagent/insuranceagents/agent_store/claim_intake_agent.yaml",
)

AGENT_GENERAL_INFO_CONFIG = os.getenv(
    "AGENT_GENERAL_INFO_CONFIG",
    "apps/rtagent/backend/src/agents/artagent/insuranceagents/agent_store/general_info_agent.yaml",
)
