...
async def handoff_merrill_advisor(args: Dict[str, Any]) -> Dict[str, Any]:
...
register_tool("handoff_merrill_advisor", handoff_merrill_advisor_schema, handoff_merrill_advisor, is_handoff=True, tags={"handoff", "investment"})
