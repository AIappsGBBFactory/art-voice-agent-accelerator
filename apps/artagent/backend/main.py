...
from apps.artagent.backend.config.app_config import AppConfig
from apps.artagent.backend.config.app_settings import (
    AGENT_AUTH_CONFIG,
    AGENT_FRAUD_CONFIG,
    AGENT_AGENCY_CONFIG,
...
from apps.artagent.backend.src.agents.stiched_agents.base import ARTAgent
...
# from apps.artagent.backend.src.routers import router as api_router
...
async def lifespan(app: FastAPI):
    ...
    async def start_event_handlers() -> None:
        ...
        from apps.artagent.backend.src.agents.stiched_agents.orchestration.orchestrator import bind_default_handlers
