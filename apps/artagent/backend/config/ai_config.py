...
AGENT_AUTH_CONFIG = os.getenv(
    "AGENT_AUTH_CONFIG", "apps/artagent/backend/src/agents/stiched_agents/agent_store/auth_agent.yaml"
)

AGENT_CLAIM_INTAKE_CONFIG = os.getenv(
    "AGENT_CLAIM_INTAKE_CONFIG",
    "apps/artagent/backend/src/agents/stiched_agents/agent_store/claim_intake_agent.yaml",
)

AGENT_FRAUD_CONFIG = os.getenv(
    "AGENT_FRAUD_CONFIG",
    "apps/artagent/backend/src/agents/stiched_agents/agent_store/fraud_agent.yaml",
)

# Transfer Agency agent configurations
AGENT_AGENCY_CONFIG = os.getenv(
    "AGENT_AGENCY_CONFIG",
    "apps/artagent/backend/src/agents/stiched_agents/agent_store/agency_agent.yaml",
)

AGENT_COMPLIANCE_CONFIG = os.getenv(
    "AGENT_COMPLIANCE_CONFIG",
    "apps/artagent/backend/src/agents/stiched_agents/agent_store/compliance_agent.yaml",
)

AGENT_TRADING_CONFIG = os.getenv(
    "AGENT_TRADING_CONFIG",
    "apps/artagent/backend/src/agents/stiched_agents/agent_store/trading_agent.yaml",
)
