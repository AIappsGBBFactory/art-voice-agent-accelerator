...
from apps.artagent.backend.src.agents.vlagents.settings.settings import get_settings
from apps.artagent.backend.src.agents.vlagents.agents_store.registry import load_registry, HANDOFF_MAP
from apps.artagent.backend.src.agents.vlagents.orchestration.orchestrator import LiveOrchestrator
from apps.artagent.backend.src.agents.vlagents.settings.session_loader import load_user_profile_by_email
...
from apps.artagent.backend.src.agents.vlagents.tool_store.tools_helper import (
	push_tool_start,
	push_tool_end,
)
	...
	async def start(self) -> None:
		...
		with tracer.start_as_current_span(
			...
			try:
				...
				span.set_attribute("voicelive.model", self._settings.azure_voicelive_model)
