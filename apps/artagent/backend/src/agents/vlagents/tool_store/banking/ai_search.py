...
MODEL_DIMENSIONS = int(os.environ.get("MODEL_DIMENSIONS", str(DEFAULT_EMBEDDING_DIMENSIONS)))
...
def _normalize_card_name(card_name: str) -> Optional[str]:
    ...
    # Use abbreviation mappings from constants
    for abbrev, full_name in CARD_NAME_ABBREVIATIONS.items():
