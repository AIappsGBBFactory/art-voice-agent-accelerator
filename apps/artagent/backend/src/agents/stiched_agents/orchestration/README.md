...
- Orchestrator package: apps/artagent/backend/src/orchestration/
...
# from apps.artagent.backend.src.orchestration.artagent.bindings import AGENT_BINDINGS, AgentBinding
...
Create apps/artagent/backend/src/agents/billing_handler.py. The easiest path is to reuse the shared specialist runner so you inherit latency tracking, history injection, and tool post-processing.

```python
# apps/artagent/backend/src/agents/billing_handler.py
from __future__ import annotations
from fastapi import WebSocket

# Helper to read from core memory safely
from apps.artagent.backend.src.orchestration.artagent.cm_utils import cm_get

# ✅ If you split helpers into modules (recommended):
from apps.artagent.backend.src.orchestration.artagent.specialists import _run_specialist_base  # adjust import if needed

# 🔁 If you're still on a single orchestrator module containing the helper:
# from apps.artagent.backend.src.orchestration import _run_specialist_base
...
from apps.artagent.backend.src.orchestration.artagent.cm_utils import cm_get
from apps.artagent.backend.src.orchestration.artagent.voice_sync import sync_voice_from_agent
from apps.artagent.backend.src.orchestration.artagent.tools_post import process_tool_response
from apps.artagent.backend.src.orchestration.artagent.metrics import track_latency
...
from apps.artagent.backend.src.orchestration import register_specialist
from apps.artagent.backend.src.agents.artagent.billing_handler import run_billing_agent
...
```python
from apps.artagent.backend.src.orchestration import configure_entry_and_specialists
...
**C) Handler — apps/artagent/backend/src/agents/billing_handler.py (from Step 3)**
