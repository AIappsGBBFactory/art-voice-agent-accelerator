...
class SessionAgentManager:
    ...
    def _apply_overrides(
        ...
        return UnifiedAgent(
            ...
            tool_names=config.tool_names_override if config.tool_names_override is not None else base.tool_names,
            template_vars={
                **base.template_vars,
    ...
    def get_base_agent(self, name: str) -> Optional[UnifiedAgent]:
...
def create_session_agent_manager(
    ...
    *,
    ...
    """
    from apps.artagent.backend.agents.loader import discover_agents, AGENTS_DIR
