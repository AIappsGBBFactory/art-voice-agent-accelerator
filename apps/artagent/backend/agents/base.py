...
class UnifiedAgent:
    ...
    def get_tools(self) -> List[Dict[str, Any]]:
        ...
        """
        from apps.artagent.backend.agents.tools import get_tools_for_agent, initialize_tools
        initialize_tools()
    ...
    def get_tool_executor(self, tool_name: str) -> Optional[Callable]:
        ...
        from apps.artagent.backend.agents.tools import get_tool_executor, initialize_tools
        initialize_tools()
        self._load_custom_tools()
    ...
    async def execute_tool(self, tool_name: str, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        from apps.artagent.backend.agents.tools import execute_tool, initialize_tools
        initialize_tools()
    ...
    def _get_greeting_context(self, context: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
        """
