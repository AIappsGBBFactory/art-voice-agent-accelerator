...
get_client_data_schema: Dict[str, Any] = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "include_history": {"type": "boolean", "description": "Include historical compliance events"},
        },
        "required": ["client_id"],
    },
}
...
log_compliance_event_schema: Dict[str, Any] = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "event_type": {
                "type": "string",
                "enum": ["kyc_update", "document_received", "exception_granted", "escalation", "review_completed"],
...
request_document_schema: Dict[str, Any] = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "document_type": {
                "type": "string",
                "enum": ["id_verification", "proof_of_address", "source_of_funds", "tax_form", "other"],
...
apply_account_restriction_schema: Dict[str, Any] = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "restriction_type": {
                "type": "string",
                "enum": ["withdrawal_limit", "trading_suspension", "account_freeze", "deposit_only"],
                "description": "Type of restriction",
            },
            "reason": {"type": "string", "description": "Reason for restriction"},
            "duration_days": {"type": "integer", "description": "Duration of restriction (0 for indefinite)"},
        },
    ...
    "regulations": [
        {
            ...
            "key_requirements": ["CTR filing for cash >$10k", "SAR filing for suspicious activity", "CDD/KYC requirements"],
        },
        {
            "title": "OFAC Sanctions",
            "summary": "Prohibits transactions with sanctioned individuals, entities, and countries.",
            "key_requirements": ["Screen all transactions", "Block prohibited transactions", "Report matches"],
        },
    ],
    "policies": [
        {
...
async def search_knowledge_base(args: Dict[str, Any]) -> Dict[str, Any]:
    ...
    for cat in categories_to_search:
        ...
        for item in items:
            if any(word in item["title"].lower() or word in item["summary"].lower() 
...
async def apply_account_restriction(args: Dict[str, Any]) -> Dict[str, Any]:
    ...
    restriction = {
        ...
        "expires_at": (datetime.now(timezone.utc) + timedelta(days=duration_days)).isoformat() if duration_days > 0 else None,
    }
...
register_tool("get_client_data", get_client_data_schema, get_client_data, tags={"compliance", "data"})
register_tool("check_compliance_status", check_compliance_status_schema, check_compliance_status, tags={"compliance", "kyc", "aml"})
register_tool("search_knowledge_base", search_knowledge_base_schema, search_knowledge_base, tags={"compliance", "knowledge"})
register_tool("log_compliance_event", log_compliance_event_schema, log_compliance_event, tags={"compliance", "audit"})
register_tool("request_document", request_document_schema, request_document, tags={"compliance", "documents"})
register_tool("apply_account_restriction", apply_account_restriction_schema, apply_account_restriction, tags={"compliance", "restrictions"})
