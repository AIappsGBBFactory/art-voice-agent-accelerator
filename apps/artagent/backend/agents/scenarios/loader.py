...
def _load_scenario_file(scenario_dir: Path) -> Optional[ScenarioConfig]:
...
def load_scenario(name: str) -> Optional[ScenarioConfig]:
    """
...
def get_scenario_agents(
    scenario_name: str,
    base_agents: Optional[Dict[str, Any]] = None,
) -> Dict[str, Any]:
    """
...
def get_scenario_start_agent(scenario_name: str) -> Optional[str]:
